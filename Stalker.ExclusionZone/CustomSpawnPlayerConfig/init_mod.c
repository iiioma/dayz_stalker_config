#include "$CurrentDir:mpmissions\Stalker.ExclusionZone\CustomSpawnPlayerConfig\Script.c"
#include "$CurrentDir:mpmissions\Stalker.ExclusionZone\CustomSpawnPlayerConfig\Sets.c"
...
modded class CustomMission
{
    ...
    {
		super.OnInit();
		GetGame().GetCallQueue(CALL_CATEGORY_SYSTEM).CallLater(My_Custom_Spawn_Parameters.Read_Update_Config, 60000, true); // Обновление настроек скрипта кастомных спавнов, 1 минута = 60000
